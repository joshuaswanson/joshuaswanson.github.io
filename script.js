...
function switchTab(tabName) {
  ...
  // Update URL hash
  const hash = tabName === "about" ? "" : tabName;
...
// Switch to tab from URL hash on load
...
window.addEventListener("hashchange", () => {
  const tab = window.location.hash.slice(1) || "about";
...
const chTranslations = {
  ...
  "about-research":
    'Mini Forschig isch i AI Security und Privacy. Im Moment studier ich wie KI für böswilligi Zwäck missbruucht cha wärde, zum Biispil für Deanonymisierig, OSINT, und Überwachig. Mini letzti Arbeit isch vo de <a href="https://inf.ethz.ch/news-and-events/spotlights/infk-news-channel/2026/05/the-more-you-post-the-easier-you-are-to-unmask.html" target="_blank" rel="noopener">ETH Züri</a> uufghoben worde und isch i de <a href="https://www.nytimes.com/2026/03/17/opinion/ai-economy-trump-future.html" target="_blank" rel="noopener">New York Times</a>, em <a href="https://www.theguardian.com/technology/2026/mar/08/ai-hackers-social-media-accounts-study" target="_blank" rel="noopener">Guardian</a>, <a href="https://www.bloomberg.com/opinion/articles/2026-03-12/anthropic-isn-t-exaggerating-about-an-ai-panopticon" target="_blank" rel="noopener">Bloomberg</a>, und anderne vorcho.',
  "about-origin": "Ich chum ursprünglich us de USA.",
  "about-socials": "Find mi im Internet:",
  "about-footnote": "Designed vo: Joshua Swanson",
  "projects-heading": "Projäkt",
  "projects-intro": "Chliini Tools und Näbeprojekt woni zum Spass bau.",
  "projects-latex-translator":
    'En Kolleg vo mir macht sin Mathe-Master und quasi d ganzi Forschig i sim Beriich isch uf Französisch. Er hät umegfröögt öb öpper es guets Tool kennt zum PDFs mit LaTeX uf Änglisch z übersetze. Stellt sich use, d Optione sind überraschend schlächht. Google Translate vermurxet d Mathe-Notation komplett, <a href="https://www.theverge.com/ai-artificial-intelligence/882891/ai-pdf-parsing-failure" target="_blank" rel="noopener">KIs händ immer na Müe mit PDFs richtig z läse</a>, und s populärschte Open-Source-Tool defür uf GitHub nimt nöd mol PDFs diräkt. Me bruucht de original LaTeX-Quällcode, wo me normalerwiis nöd hät, also muess me für <a href="https://mathpix.com/" target="_blank" rel="noopener">Mathpix</a> zahle zum s PDF zersch z LaTeX z konvertiere, denn es Command-Line-Tool laufe laa, und denn de Output zrugg z PDF kompiliere. Min Kolleg wäiss nöd wie me es Repo clonet oder d Command Line bruucht. Und ehrlech gsäit sött er das au nöd müesse. Was relativ guet funktioniert isch gerenderets LaTeX z screenshotte und em ChatGPT (oder dim LLM wo du wottsch) z füettere, wo denn meischtens s LaTeX cha reproduziere und übersetze, aber das isch extrem umständlech und ineffizient für es ganzes Dokumänt. Wieso gits käis äifachs, benutzerfrüündlechs Online-Tool defür? Ich bi echt überrascht gsii dass es da e Lücke git, also bini ane und ha en <a href="https://joshuaswanson.github.io/latex-pdf-translator/" target="_blank" rel="noopener">LaTeX PDF Translator</a> baut. PDF ufelade, Sprach uuswähle, und me überchunt e übersetzti Version wod Gliichige alli perfekt intakt bliibed. Fair Warning: es isch langsam wills sequenzieli Google Translate API Calls macht, und es lauft uf emene gratis Render Server. Aber hey, es isch gratis. Es isch au na echli buggy, aber je meh PDFs mir d Lüüt schicked desto meh chani dra schaffe zum s z fixe.',
  "projects-monitor":
  ...
  "ballroom-etds2026":
    'Ich tanze am 71. <a href="https://en.wikipedia.org/wiki/European_Tournament_for_Dancing_Students" target="_blank" rel="noopener">ETDS</a> (European Tournament for Dancing Students) z\'Enschede i de Niederlande.',
  "ballroom-past": "Vergange",
  "ballroom-trafo":
    'Ich bi 4. worde i de D-Klass Latin am <a href="https://www.dancesport.ch/events/trafo-cup/" target="_blank" rel="noopener">Trafo Cup</a> z\'Bade i de Schwiiz.',
  "ballroom-sm":
    'Ich bi 4. worde i de D-Klass a de <a href="https://www.dancesport.ch/events/schweizer-meisterschaften-standard-26/" target="_blank" rel="noopener">Schwiizer Meisterschafte Standard</a> z\'Bade i de Schwiiz.',
  "ballroom-license":
